...
public class DatacenterBroker extends SimEntity {
	...
	protected void processResourceCharacteristicsRequest(SimEvent ev) {
		...
		Log.printLine("Cloud Resource List received with "
	...
	protected void processVmCreate(SimEvent ev) {
		...
		if (result == CloudSimTags.TRUE) {
			...
			Log.printLine("VM #" + vmId
					+ " has been created in Datacenter #" + datacenterId + ", Host #"
					+ VmList.getById(getVmsCreatedList(), vmId).getHost().getId());
		} else {
			Log.printLine("Creation of VM #" + vmId
	...
	protected void processCloudletReturn(SimEvent ev) {
		...
		Log.printLine("At "+CloudSim.clock()+","+ "Cloudlet:" + cloudlet.getCloudletId()
				+ "-Finished the execution");
		Log.printLine("-----------------------------------------------------------------------------------------");
		cloudletsSubmitted--;
		if (getCloudletList().size() == 0 && cloudletsSubmitted == 0) { // all cloudlets executed
			Log.printLine("All Cloudlets executed. Finishing...");
			clearDatacenters();
			finishExecution();
	...
	protected void createVmsInDatacenter(int datacenterId) {
		...
		for (Vm vm : getVmList()) {
			if (!getVmsToDatacentersMap().containsKey(vm.getId())) {
				Log.printLine("Trying to Create VM #" + vm.getId()
						+ " in " + datacenterName);
	...
	protected void submitCloudlets() {
		...
		int count=1;
		Log.printLine("Sorted List of Cloudlet with thier length is:\n");
		...
		Log.printLine("The average Length of the Cloudlet is:\t"+avgCloudletLength);
		Log.printLine("===============================================================================");
		Log.printLine("Allocating the tasks to the VM's");
		...
		for (Cloudlet cloudlet : sortList) {
			...
			if(cloudlet.getCloudletLength() < avgCloudletLength && noOfCloudletsOfVm1 < noOfCloudletsOfVm2)
			{
				...
				Log.printLine( "\tSending cloudlet "
		...
		Log.printLine("================================================================================================");
Log.printLine("Reporting the finishing time of the cloudlet execution\n");
	...
	protected void clearDatacenters() {
		for (Vm vm : getVmsCreatedList()) {
			Log.printLine("Destroying VM #" + vm.getId());
